...
public class GameLogicTest {
    ...
    @Test
    public void test_move_up() throws Exception {
    ...
    @Test
    public void test_clone_GameLogic() throws Exception {
        int[][] board3 = {{2, 4, 2, 8}, {0, 8, 4, 8}, {2, 4, 0, 16}, {4, 2, 2, 0}};
        setBoard(board3);

        logic.move(MoveDirection.DOWN);
        GameLogic newLogic = (GameLogic) logic.clone();
        Assert.assertTrue(newLogic.isEqual(logic.getBoard()));
        Assert.assertTrue(newLogic.isMoved());
        Assert.assertEquals(logic.getScore(), newLogic.getScore());
    }
}
